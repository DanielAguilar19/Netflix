<template>
    <div class="fixed w-full h-screen bg-black">
        ...
        <div v-if="!showFullVideo" id="SideNav" class="flex z-40 items-center w-[3vw] h-screen bg-black relative">
            <img class="absolute top-0 w-[30px] mt-10 ml-10" src="/images/netflix-logo.png" alt="" />
            <sideBar/>
        </div>

        <div v-if="!showFullVideo">
            <div class="fixed flex z-20 top-0 left-0 w-[100vw] h-[30vh] bg-black pl-[120px] bg-clip-border">
                <div
            ...
            <div class="fixed z-30 bottom-0 right-0 w-full h-[40%] pl-[120px] overflow-y-auto">
                <div class="fixed z-30 bottom-0 right-0 w-full h-[40%] pl-[120px] overflow-y-auto">
